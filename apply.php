...
<table width="100%" border="0" >
   <tr>
     ...
     <td width="468" height="57"><h1 align="left"><span class="style8">CANDIDATE APPLICATION</span></h1></td>
     
   </tr>
   

   <tr>
     <td><form name="application" method="post" action="processapplication.php" enctype="multipart/form-data" onSubmit="return check();">
...
<tr>
		...
		<div ><td><input type="file"name="image1" required></td></div>
		</tr>
...
<td><div > Position:</div></td>
		...
		<option style='color:red'> chairman</option>
		...
		<option> </option>
         ...
         <tr>
           <td>&nbsp;</td>
           <div><td><input type="submit" name="submit" value="submit">
		   <input type='reset' value='reset'><br/><br/>
           <a href='deligate.php' style='color:green'><center><B>OR DELIGATE APPLICATION</B></center></a>
